...
import com.xh.common.utils.ResultUtil;
import com.xh.common.utils.UuidUtils;
import com.xh.entity.Sys_User;
import com.xh.entity.Sys_record;
import com.xh.entity.Sys_record_attend;
import com.xh.entity.Sys_record_commissioner;
import com.xh.service.AttendService;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.xh.annotation.SLog;
import com.xh.entity.*;
import com.xh.service.CommissionerService;
import com.xh.service.RecordService;
...
public class RecordController {
    ...
    public Object editRoomDo(Sys_record record, String commissionerId, String attendId) {
        ...
        attendService.removeByMap(new HashMap<String, Object>() {{
            put("recordId", recordId);
        }});
        attendService.saveBatch(attends, attends.size());
        commissionerService.removeByMap(new HashMap<String, Object>() {{
            put("recordId", recordId);
        }});
